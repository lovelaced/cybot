...
def interjection():  # I'd just like to interject for a moment
    ircsock.send("PRIVMSG "+channel + " :I'd just like to interject for moment. What you're referring to as Linux, "
                                      "is in fact, GNU/Linux, or as I've recently taken to calling it, GNU plus Linux. "
                                      "pastebin.com/2YxSM4St\n")


def memearrows():  # >implying you can triforce
    ircsock.send("PRIVMSG "+channel + " :Meme arrows are often used to preface implications or feels. See also: "
                                      "implying, feel.\n")
...
def autointerject(user):  # making sure users don't forget the GNU
    ircsock.send("PRIVMSG "+channel +
                 " :I'd just like to interject for moment. What you're referring to as Linux, is in fact, GNU/Linux - "
                 "further messages sent privately.\n")
    ircsock.send("PRIVMSG "+user + " :I'd just like to interject for moment. What you're referring to as Linux, is "
    ...
    ircsock.send("PRIVMSG "+user + " :There really is a Linux, and these people are using it, but it is just a part of "
    ...
    ircsock.send("PRIVMSG "+user + " :Linux is normally used in combination with the GNU operating system: the whole "
...
def implying():  # >implying this needs a comment
    ircsock.send("PRIVMSG "+channel + ' :>implying is used in a mocking manner to challenge an "implication" that has '
                                      'been made, or sometimes it can be simply used as a joke in itself.\n')
...
def shitpost():  # almost entire automated shitpost# ing
    post = "None"
    while post == "None":
